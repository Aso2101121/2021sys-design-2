...
|注文ID     |order_id      |int(20)       |〇  |〇   |〇  |デフォルト値:０|
...
|顧客コード     |customer_code  |int(11)           |〇  |〇   |〇  |-             |
|商品名         |item_name      |varchar(20)      |-   |-    |〇   |-            |
...
|顧客コード   |costomer_code  |varchar(50)        |-  |〇  |〇  |顧客テーブル参照|
...
|商品コード     |item_code     |int(11)             |〇  |〇  |〇   |商品テーブル参照|
